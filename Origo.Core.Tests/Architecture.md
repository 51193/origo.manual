...
| `ISndContext_ShouldInheritAllRoleInterfaces` | ISndContext 继承全部 10 个角色接口（含 ISndFileAccess） | Snd Abstraction: ISndContext 组合 |
...
| `Consumer_AccessesAllRoleInterfaces_ThroughISndContext` | 通过 ISndContext 可访问全部 10 个角色接口的能力（含 ISndFileAccess 读写文件） | Snd Abstraction |
