...
| 子模块 | 能力 | 详情 |
|--------|------|------|
| [CommandHandlers](CommandHandlers/README.md) | 10 个内置命令处理器 | help / bb_get / bb_set / bb_keys / spawn / find_entity / request_clear_entities / snd_count / entity_get_data / entity_set_data |
